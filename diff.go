...
// DiffOutput is a helper function that compares unsorted ScriptFilter output.
// It returns "" if `gotData` is equal to `wantData` regardless of sorted or unsorted
// Format: -want +got
